...
5. **Создать объявление:**
   ...
   **Лимиты символов:**
   | Поле | Макс. символов | Доп. ограничения |
   |------|---------------|-------------------|
   | title (заголовок 1) | 56 | каждое слово ≤ 22 симв |
   | title2 (заголовок 2) | 30 | показывается не всегда |
   | text (текст) | 81 | каждое слово ≤ 23 симв |
   | Отображаемая ссылка | 20 | только при наличии Href |
   | Быстрая ссылка: текст | 30 | до 8 ссылок в наборе |
   | Быстрая ссылка: описание | 60 | — |
   | Сумма текстов sitelinks 1–4 | 66 | при 4 коротких ссылках хватит, длинные — урезай |
   | Сумма текстов sitelinks 5–8 | 66 | вторая половина считается отдельно |
   | Уточнение | 25 | до 50 уточнений на объявление |

   > **«Узкие» символы** `! , . ; : "` — не учитываются в лимите длины (можно «забесплатно» до 15 шт). Полезно при упирании в потолок Title.
