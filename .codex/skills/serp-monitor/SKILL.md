---
name: serp-monitor
description: "Мониторинг позиций в Яндексе: проверка позиций по ключевым, анализ конкурентов, отслеживание динамики."
---
...
Анализ конкурентов не требует отдельного скрипта — агент анализирует выдачу из `search.sh`.

### Шаги:

1. **Собрать выдачу** — запустить `search.sh` для 5-10 ключевых запросов кампании
2. **Анализ рекламных текстов** конкурентов из результатов:
